...
anuncioSchema.statics.listapi = async function(filters, startRow, numRows, sortField, includeTotal, cb) {
...
anuncioSchema.statics.list = async function(filters, startRow, numRows, sortField, doPaginacion, pagina, cb) {
